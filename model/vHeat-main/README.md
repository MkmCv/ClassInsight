...
We added Windows-friendly docs:

- See `docs/Windows-Setup.md` for environment setup (Conda, PyTorch+CUDA), dataset layout, and single-GPU usage on Windows.
- See `docs/Knowledge-Base.md` for quick commands and tips. For multi-GPU training and MMDetection/MMSegmentation, we recommend WSL2 or Linux.
